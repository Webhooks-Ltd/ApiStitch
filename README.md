...
- MSBuild task integration (use the CLI for now)
- Extension method output style
- Refit interface output style
- NuGet package publishing (run the CLI from source)
- Attribute-based type discovery (`[OpenApiSchema]`)
